...
servicios = {
    "1": {"key":"arbitraje","tipo":"herramienta","nombre":"Arbitraje Triangular","info":"""🔀 Herramient de Arbitraje Triangular
...
🔹 Lo convertimos en un sistema 100% automatizado
...
⏰ En aproximadamente 24 horas recibirás tu sistema listo para usar en tu broker.

🚀 Automatiza tus operaciones y lleva tu trading al siguiente nivel.

🎥 🔥 Mira cómo funciona aquí 👇
https://youtube.com/@tradingautomaticoo""","precio":"""💰 Planes de Automatización
...
📊 Recibe operaciones directamente en tu cuenta de forma automática.
...
💰 Ganancias estimadas  
Entre 5 y 17 USD diarios, según tu capital
...
🚀 Tenemos algunos espacios disponibles todavía.
...
📈 Resultado  
Recibes el 50% de ganancia + el 100% de tu capital al finalizar el ciclo

🚀 Ejemplo  
Si inviertes 100 USD → recibes 150 USD  
...
https://t.me/inversioneess""","enlace":"""📋 Requisitos para ingresar al Fondo de Inversión FDI
...
Recibes el 50% de ganancia + tu capital directamente en tu billetera.
